...
def index():
    if request.method == "POST":
        try:
            ...
            diagram_path, tabel_path = algorithm.plot_waktu_perbandingan(data=json_data, ukuran_dataset=ukuran_dataset)

            return render_template('index.html', plot_path=diagram_path, table_path=tabel_path)
